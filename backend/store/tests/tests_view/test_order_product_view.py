...
class TestFindByIdOrderProduct:
    ...
    @patch("store.service.order_product.FindByIdOrderProductService.find_by_id")
    ...
    def test_find_by_id_invalid_input_data(self, mock_find_by_id):
        mock_find_by_id.side_effect = InvalidInputData("Invalid input data.")
...
class TestCreateOrderProduct:
    ...
    @patch("store.service.order_product.CreateOrderProductService.create")
    ...
    def test_create_invalid_input_data(self, mock_create):
        mock_create.side_effect = InvalidInputData("Invalid input data.")
...
class TestUpdateOrderProduct:
    ...
    @patch("store.service.order_product.UpdateOrderProductService.update")
    ...
    def test_update_invalid_input_data(self, mock_update):
        mock_update.side_effect = InvalidInputData("Invalid input data.")
...
class TestDeleteOrderProduct:
    ...
    @patch("store.service.order_product.DeleteOrderProductService.delete")
    def test_delete_success(self, mock_delete):
        mock_delete.return_value = "Order deleted successfully."

        response = self.client.delete("/order_product/delete", data=self.data, format="json")
    ...
    def test_delete_invalid_token(self, mock_delete):
        ...
        response = self.client.delete("/order_product/update", data=self.data, format="json")
    ...
    def test_delete_invalid_input_data(self, mock_delete):
        mock_delete.side_effect = InvalidInputData("Invalid input data.")
