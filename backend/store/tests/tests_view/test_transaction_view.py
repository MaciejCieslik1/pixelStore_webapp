...
class TestDeleteProductReview:
    def setup_method(self):
        ...
        self.transaction_communicate = "Transaction deleted successfully"

    @patch("store.service.transaction_service.DeleteTransactionService.delete")
    def test_delete_success(self, mock_delete):
        mock_delete.return_value = self.transaction_communicate

        response = self.client.delete(f"/transaction/delete/{self.transaction_id}/")
