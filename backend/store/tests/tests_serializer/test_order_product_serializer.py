...
from store.serializers.order_product_serializer import FindByIdOrderProductSerializer, DeleteOrderProductSerializer, \
    CreateOrderProductSerializer, UpdateOrderProductSerializer
...
class TestCreateOrderProductSerializer(unittest.TestCase):
    ...
    def test_create_shopping_price_max_integer(self):
        ...
        self.assertEqual(serializer.errors, {"shopping_price": "Shopping price must be positive integer."})
    ...
    def test_create_empty_shopping_price(self):
        ...
        self.assertFalse(result)
        self.assertNotEqual(serializer.validated_data, self.validated_data)
        self.assertEqual(serializer.errors, {"shopping_price": "Shopping price username cannot be empty."})
    ...
    def test_create_sopping_price_string(self):
        ...
        self.assertFalse(result)
        self.assertNotEqual(serializer.validated_data, self.validated_data)
        self.assertEqual(serializer.errors, {"shopping_price": "Shopping price must be positive decimal number."})
...
class TestUpdateOrderProductSerializer(unittest.TestCase):
    def setUp(self):
        ...
        self.validated_data = {"shopping_price": 1000}
    ...
    def test_update_sopping_price_string(self):
        self.data["shopping_price"] = "sfdfffs"
        serializer = UpdateOrderProductSerializer(data=self.data)
