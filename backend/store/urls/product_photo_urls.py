...
from store.views.product_photo_view import FindByIdProductPhotoView, FindAllForProductView, CreateProductPhotoView, \
    DeleteProductPhotoView, FindMainPhotoProductPhotoView

find_by_id_product_photo_service = FindByIdProductPhotoService()
find_all_for_product_service = FindAllForProductService()
find_main_photo_product_photo_service = FindMainPhotoProductPhotoService()
...
urlpatterns = [
    ...
    path("find_main_photo/<int:product_id>/", FindMainPhotoProductPhotoView.as_view(find_main_photo_product_photo_service=find_main_photo_product_photo_service),
         name="find_main_photo_product_photo"),
