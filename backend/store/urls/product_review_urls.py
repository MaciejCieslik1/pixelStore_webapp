...
urlpatterns = [
    ...
    path("find_all_for_product/", FindAllProductReviewsView.as_view(
        find_all_product_reviews_service=find_all_product_reviews_service),
         name="find_all_product_reviews"),
    path("find_all_from_user/", FindAllFromUserProductReviewsView.as_view(
        find_all_from_user_product_reviews_service=find_all_from_user_product_reviews_service),
         name="find_all_from_user_product_reviews"),
