...
from store.views.transaction_view import FindByIdTransactionView, FindAllMineTransactionsView, UpdateTransactionView, \
    DeleteTransactionView, CreateTransactionView
...
delete_service = DeleteTransactionService()
...
urlpatterns = [
    ...
    path("find_all_mine_transactions/", FindAllMineTransactionsView.as_view(
    ...
    path("delete/<int:transaction_id>/", DeleteTransactionView.as_view(delete_transaction_service=delete_service),
         name="delete_transaction/<int:transaction_id>"),
]
